        ...
        return (
            <Form>
                <Grid container spacing={2} p={2}>
                    ...
                    <Grid item xs={12}>
                        <Stack>
                            <Typography variant="h6">How did you learn about DBM Legal Services?</Typography>
                            <Field
                    ...
                    <Grid item xs={12}>
                        <Stack>
                            <Typography variant="h6">Are you looking for hourly or flat-fee billing?</Typography>
                            <Field
                                component={GenericRadioGroup}
                        ...
                        <Formik
                            ...
                            validationSchema={
                                (formSource == 'new-client-form'
                                    ...
                                    : Yup.object({
                                          pointOfContactName: Yup.string('Enter a name.').required(
                                              'Name is required.'
                                          ),
                                          pointOfContactEmail: Yup.string('Enter an email')
